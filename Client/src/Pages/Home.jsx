...
export default function Home() {
    ...
    return (
        <div className="home">
            <div className="welcome" style={{ fontSize: '60px', lineHeight: '50px' }}> Welcome to FrosTrack</div><br></br>
            ...
            <div style={{ display: 'inline-flex', marginInline: '20px' }} >
                <Link to="/CSignup" className="signBut" >Customer</Link>
                <Link to="/OSignup" className="signBut" >Owner</Link>
            </div>
