  ...
  return (
    <>
      ...
      <div className="back">
        ...
        <div className="hub">
          <div className="row">
            <Link to="/CProfile" className="tile" style={{ width: "35%" }}>
              <svg
                fill="#ffffff"
                viewBox="0 0 24 24"
            ...
            <Link to="/CPurchases" className="tile" style={{ width: "65%" }}>
              <svg
                fill="#ffffff"
                width="245px"
                height="245px"
          ...
          <div className="row">
            <Link to="/CChambers" className="tile" style={{ width: "70%" }}>
              <svg
                fill="#ffffff"
                width="163px"
                height="163px"
            ...
            <Link to="/CCommodities" className="tile" style={{ width: "30%" }}>
              <svg
                viewBox="0 0 24 24"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
